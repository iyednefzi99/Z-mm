...
\texttt{ConfigBKS.ini} & \texttt{application.yml} + \texttt{@ConfigurationProperties} & Parametrage sans recompilation, injectable par profil ; les seuils et unites deviennent des beans types. \\
...
Web service API XML \texttt{getBeeHouseHoneyActualQuantity} & API REST JSON (\texttt{@GetMapping}) + OpenAPI / Swagger & JSON au lieu de XML, documentation auto-generee ; XML reste possible via \texttt{produces = APPLICATION\_XML}. \\
...
\texttt{MessageSource}, \texttt{ConfigBKS.ini} \textrightarrow{}
