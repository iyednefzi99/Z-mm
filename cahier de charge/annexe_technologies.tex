...
\begin{longtable}{>{\bfseries}p{3.1cm} p{4.9cm} p{5.4cm}}
\toprule
...
Présentation      & HTML5 + JavaScript + Bootstrap 5  & IHM responsive, parité web / mobile \\
...
\begin{longtable}{>{\bfseries}p{2.7cm} p{4.2cm} p{6.5cm}}
\toprule
