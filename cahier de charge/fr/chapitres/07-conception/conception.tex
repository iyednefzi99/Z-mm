...
\node[draw=mielfonce,thick,fill=miel!15,minimum height=8mm,font=\footnotesize,align=center,text width=3.1cm,right=4mm of c] (s) {i18n XML\\ConfigZumm.ini\\Services web};
