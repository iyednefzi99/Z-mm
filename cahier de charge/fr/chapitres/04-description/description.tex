...
\begin{itemize}
  ...
  \item \textbf{Robustesse} : ingestion \textbf{asynchrone} par file d'attente, avec
...
\midrule
Déploiement autonome & Installation conteneurisée sans abonnement ni service tiers obligatoire & Haute \\
...
\midrule
\endhead
Abonnement payant et paywall & Système autodéployable sur son propre serveur, sans abonnement obligatoire, l'ensemble des fonctions de gestion reste accessible. \\
