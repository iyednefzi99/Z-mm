...
Spring Boot & Cadre applicatif Java : injection de dépendances, configuration automatique et serveur embarqué. \\
JPA & Interface standard de correspondance entre objets Java et tables relationnelles. \\
jOOQ & Bibliothèque de requêtes SQL typées, vérifiées à la compilation. \\
OpenAPI & Contrat décrivant une API REST, exploitable par l'humain et par la machine. \\
OAuth / OIDC & Protocoles d'autorisation et d'authentification déléguée. \\
X.509 & Certificats assurant l'authentification des parties dans un échange chiffré. \\
