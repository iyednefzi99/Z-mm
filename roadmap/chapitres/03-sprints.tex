...
\textbf{10 sprints de construction de 14 jours} (22 semaines au total), du
14 juillet au 14 décembre 2026, avec une capacité de référence de
40 points par sprint. Les sprints 9 et 10 prolongent le plan initial, arrêté
à S8 : le premier livre les fonctions d'exploitation, le second exploite la
base spatiale et solde la dette de test du front. Chaque sprint est décrit ci-dessous avec son
...
\begin{ganttchart}[
  ...
  ]{2026-07-14}{2026-12-14}
  % Titres de mois en français (juil. : 18 j, déc. : 14 j)
  \gantttitle{juillet}{18}
  \gantttitle{août}{31}
  \gantttitle{septembre}{30}
  \gantttitle{octobre}{31}
  \gantttitle{novembre}{30}
  \gantttitle{décembre}{14} \\
...
\end{ganttchart}
\caption{Diagramme de Gantt du sprint de cadrage, des 10 sprints de
construction et des 4 jalons de release.}
...
\midrule
\multicolumn{3}{r}{\textbf{Total}} & \textbf{364} & \textbf{49 stories} \\
\bottomrule
\end{tabular}
\end{center}
