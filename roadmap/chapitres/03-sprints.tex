...
\textbf{11 sprints de construction de 14 jours}, du 14 juillet 2026 au
18 janvier 2027, avec une capacité de référence de 40 points par sprint. Les
sprints 9 à 11 prolongent le plan initial, arrêté à S8 : le premier livre les
fonctions d'exploitation, le deuxième exploite la base spatiale et solde la
dette de test du front, le troisième corrige ce qu'un audit du front a révélé.
...
\begin{ganttchart}[
  ...
  ]{2026-07-14}{2027-01-18}
  % Titres de mois en français (juil. : 18 j, janv. : 18 j)
  \gantttitle{juillet}{18}
  \gantttitle{août}{31}
  \gantttitle{septembre}{30}
  \gantttitle{octobre}{31}
  \gantttitle{novembre}{30}
  \gantttitle{décembre}{31}
  \gantttitle{janvier}{18} \\
  \ganttbar[bar/.append style={fill=vertsauge!40}]{S0 -- Cadrage \& walking skeleton (hors vélocité)}{2026-07-14}{2026-07-27} \\
  \ganttbar{S1 -- Fondation \& configuration (36 pts)}{2026-07-28}{2026-08-10} \\
  \ganttbar{S2 -- Ruche, i18n \& qualité (39 pts)}{2026-08-11}{2026-08-24} \\
  \ganttmilestone{v0.1.0}{2026-08-25} \\
  \ganttbar{S3 -- Visites \& rapports (36 pts)}{2026-08-25}{2026-09-07} \\
  \ganttbar{S4 -- Hors-ligne, auth \& RBAC (39 pts)}{2026-09-08}{2026-09-21} \\
  \ganttmilestone{v0.2.0}{2026-09-22} \\
  \ganttbar{S5 -- Tableaux de bord (39 pts)}{2026-09-22}{2026-10-05} \\
  \ganttbar{S6 -- Synthèse, capteurs \& API (39 pts)}{2026-10-06}{2026-10-19} \\
  \ganttmilestone{v0.3.0}{2026-10-20} \\
  \ganttbar{S7 -- Fonctions avancées \& IA (39 pts)}{2026-10-20}{2026-11-02} \\
  \ganttbar{S8 -- Qualité \& livraison (37 pts)}{2026-11-03}{2026-11-16} \\
  \ganttmilestone{v1.0.0}{2026-11-16} \\
  \ganttbar{S9 -- Exploitation \& durcissement (26 pts)}{2026-11-17}{2026-11-30} \\
  \ganttbar{S10 -- Intelligence spatiale (34 pts)}{2026-12-01}{2026-12-14} \\
  % Trêve de fin d'année : le S11 reprend le 5 janvier.
  \ganttbar{S11 -- Fiabilité session \& front (34 pts)}{2027-01-05}{2027-01-18}
\end{ganttchart}
\caption{Diagramme de Gantt du sprint de cadrage, des 11 sprints de
construction et des 4 jalons de release. Le décrochage entre S10 et S11
correspond à la trêve de fin d'année.}
...
\midrule
\multicolumn{3}{r}{\textbf{Total}} & \textbf{398} & \textbf{54 stories} \\
\bottomrule
\end{tabular}
\end{center}
