...
\bottomrule
\endlastfoot
R-01 & Intégration PostGIS/Spring Boot plus complexe que prévu
     & S1 & 2 & 3 & \textbf{6}
...
\textbf{Périmètre de ce tableau : le plan initial à 8 sprints}, avant
rééquilibrage et avant l'extension à 18 sprints (chapitre~\ref{chap:sprints},
§\ref{sec:recommandations}). Il est conservé parce que c'est lui qui a servi à
coter le risque \textbf{R-07} (surcharge de S5 et S7) et à justifier le passage
de la capacité de référence à 40 points --- le remplacer par les chiffres
d'aujourd'hui effacerait la raison d'être de cette cotation. Les totaux à jour
--- 18 sprints, 582 points, 540 j-h --- sont au chapitre~\ref{chap:sprints}.
...
code, soit \textbf{540 j-h} sur les 18 sprints de construction. Le ratio
obtenu, $\approx 0{,}93$ j-h par story point, suppose une équipe déjà à l'aise
avec la pile Spring Boot ; pour une équipe qui la découvre, compter plutôt
1,2 j-h par point --- soit $\approx 700$ j-h au total, ou $\approx 39$ j-h par
