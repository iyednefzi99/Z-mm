...
Le backlog est structuré en \textbf{13 epics} couvrant l'intégralité du
périmètre du cahier des charges, pour un total de \textbf{54 user stories}
et \textbf{398 story points} (suite de Fibonacci : 1, 2, 3, 5, 8, 13).
...
\midrule
\multicolumn{4}{r}{\textbf{Total}} & \textbf{398} \\
\bottomrule
\end{tabular}
\end{center}
