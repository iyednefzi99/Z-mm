...
\textbf{ID} & \textbf{Story} & \textbf{Pts} & \textbf{Priorité} & \textbf{Critères d'acceptation} \\
\midrule
US-026 & Service web XML \texttt{getZummHoneyActualQuantity} & 5 & Moyenne & JAX-WS SOAP + WSDL \\
...
US-030 & Carte et rayons de butinage    & 8 & Moyenne & Leaflet + OpenStreetMap + cercles 1/2/3 km \\
...
US-037 & Tests d'intégration (Arquillian)    & 5  & Haute   & Tests \emph{in-container} \\
