...
planification en \textbf{8 sprints} de deux semaines, une chaîne
d'intégration et de déploiement continus (CI/CD), un plan de releases
sémantiques et un dispositif de monitoring.
...
\begin{encadre}
\textbf{Note de cohérence.} Les fichiers source \texttt{sprints.json} et
\texttt{releases.json} annonçaient 284 points planifiés ; la somme réelle des
stories affectées aux sprints est de \textbf{304 points} (écarts sur les
sprints 5, 7 et 8). Ce document retient les valeurs recalculées, cohérentes
avec le product backlog.
\end{encadre}