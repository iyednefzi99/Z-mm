...
planification en \textbf{20 sprints} de deux semaines avec plans d'exécution
...
\begin{encadre}
\textbf{Chiffres clés.} 21 epics --- 92 user stories --- 651 story points ---
1 sprint de cadrage + 20 sprints de 14 jours --- 4 releases
...
atteindre \textbf{20 sprints de construction et 651 points}. La somme des
\texttt{story\_points} des vingt-et-un sprints de \texttt{sprints.json} égale
...
\smallskip
\textbf{Réserve sur la vélocité annoncée.} Sur les 651 points, \textbf{21 ne
sont pas livrés} : ce sont des \textbf{livrables documentaires} (US-039
diagrammes UML, US-040 rapport et soutenance) que la charte de l'épreuve interdit
de générer. Les 35 points du sprint 20, encore en cours au relevé précédent, sont
livrés depuis le 29/08/2026. La vélocité \emph{applicative} réellement livrée est
donc de \textbf{630 points}. Le compter autrement serait surévaluer le livrable.
\end{encadre}